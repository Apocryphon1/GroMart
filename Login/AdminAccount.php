          ...
          <form action="login.php" method="POST">
            ...
            <div id="menu_tab">
              <ul class="menu">
                ...
                <li><a href="../Admin/Content/Content.php" class="nav">Edit Content</a></li>
                <li class="divider"></li>

                <li><a href="../Admin/manageAccounts/manageAccounts.php" class="nav">Manage Accounts</a></li>
                <li class="divider"></li>

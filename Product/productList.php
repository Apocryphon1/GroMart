...
<head>
  ...
  <?php include '../PHP/retrieveProducts.php'?>
</head>
      ...
      <div class="center_content">
        ...
        <div class="prod_box">
          <div class="center_prod_box">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[0]->img; ?> height=70px width=40px alt=""
                  border="0" /></a></div>
          ...
          <div class="prod_details_tab"> <button id="add" onclick="indexCart('Pepsi Can' ,5 )" class="prod_buy">Add to
              Cart</button>
              <button id="ModalBtn" class="prod_details">Details</button></div>
              <div id="modalP" class="prodModal">
              <!-- Modal -->
              <div class="prodModal-content">
        ...
        <div class="prod_box">
          <div class="center_prod_box" id="pr3">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[2]->img;?> height=70px width=50px alt=""
                  border="0" /></a></div>
        ...
        <div class="prod_box">
          <div class="center_prod_box" id="pr4">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[3]->img?> height=70px width=50px alt=""
                  border="0" /></a></div>
        ...
        <div class="prod_box">
          <div class="center_prod_box" id="pr5">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[4]->img?> height=70px width=50px alt=""
                  border="0" /></a></div>
        ...
        <div class="prod_box">
          <div class="center_prod_box" id="pr6">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[5]->img?> height=70px width=50px alt=""
                  border="0" /></a></div>
        ...
        <div class="prod_box">
          <div class="center_prod_box">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[6]->img?> height=70px width=40px alt=""
                  border="0" /></a></div>
        ...
        <div class="prod_box">
          <div class="center_prod_box">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[7]->img?> height=70px width=40px alt=""
                  border="0" /></a></div>
        ...
        <div class="prod_box">
          <div class="center_prod_box">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[8]->img?> height=70px width=40px alt=""
                  border="0" /></a></div>
        ...
        <div class="prod_box">
          <div class="center_prod_box">
            ...
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[9]->img?> height=70px width=40px alt=""
                  border="0" /></a></div>
        ...
        <div class="prod_box">
          <div class="center_prod_box">
            <div class="product_title"><a href="#"><?php echo $myProduct[10]->name?></a></div>
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[10]->img?> height=70px width=40px alt=""
                  border="0" /></a></div>
            <div class="prod_price"><span class="reduce"><?php echo $myProduct[10]->price . ' EGP'?></span> <span class="price"><?php echo $myProduct[10]->discount . ' EGP'?></span></div>
          </div>
          <div class="prod_details_tab"> <button id="add" onclick="indexCart('Listerine' ,5 )" class="prod_buy">Add to
              Cart</button> <button onclick="document.location='ProductPage(10).html'" class="prod_details">Details</button> </div>
        </div>
        <div class="prod_box">
          <div class="center_prod_box">
            <div class="product_title"><a href="#"><?php echo $myProduct[11]->name?></a></div>
            <div class="product_img"><a href="#"><img src=<?php echo $myProduct[11]->name?> height=70px width=40px alt=""
                  border="0" /></a></div>
            <div class="prod_price"> <span class="price"><?php echo $myProduct[11]->price . ' EGP'?></span></div>
          </div>
          <div class="prod_details_tab"> <button id="add" onclick="indexCart('Water x12' ,5 )" class="prod_buy">Add to
              Cart</button> <button onclick="document.location='ProductPage(11).html'" class="prod_details">Details</button> </div>
        </div>
      </div>
